...
CREATE SEQUENCE nomination_id_seq START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
CREATE TABLE nomination (id integer NOT NULL DEFAULT nextval('nomination_id_seq'), name text, movie_name text, description text, url text, pic text);
ALTER TABLE ONLY nomination ADD CONSTRAINT nomination_pkey PRIMARY KEY (id);
